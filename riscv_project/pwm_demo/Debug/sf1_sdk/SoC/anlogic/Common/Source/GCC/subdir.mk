...
sf1_sdk/SoC/anlogic/Common/Source/GCC/%.o: ../sf1_sdk/SoC/anlogic/Common/Source/GCC/%.S
	...
	riscv-nuclei-elf-gcc -march=rv32imac -mabi=ilp32 -mcmodel=medany -mno-save-restore -O0 -ffunction-sections -fdata-sections -fno-common  -g -x assembler-with-cpp -DDOWNLOAD_MODE=DOWNLOAD_MODE_WORK3 -I"D:\a_liulanqixiazai\SF1_PWM\riscv_project\pwm_demo\sf1_sdk\SoC\anlogic\Board\sf1_eval\Include" -I"D:\a_liulanqixiazai\SF1_PWM\riscv_project\pwm_demo\application" -I"D:\a_liulanqixiazai\SF1_PWM\riscv_project\pwm_demo\sf1_sdk\NMSIS\Core\Include" -I"D:\a_liulanqixiazai\SF1_PWM\riscv_project\pwm_demo\sf1_sdk\SoC\anlogic\Common\Include" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
