...
#define SOC_I2C_SCK_GPIO_OFS        6
#define SOC_I2C_SDA_GPIO_OFS        7
...
#define SOC_I2C_SCK_GPIO_MASK		(1<<SOC_I2C_SCK_GPIO_OFS)
#define SOC_I2C_SDA_GPIO_MASK		(1<<SOC_I2C_SDA_GPIO_OFS)
